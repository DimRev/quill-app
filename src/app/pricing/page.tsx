...
const Page = async (props: Props) => {
  ...
  const pricingItems: PricingItem[] = [
    ...
    },
    {
      ...
      quota: PLANS.find((p) => p.slug === 'Pro')?.quota as number,
      features: [
        {
      ...
      <MaxWidthWrapper className="mb-8 mt-24 max-w-5xl text-center">
        <div className="mx-auto mb-10 sm:max-w-lg">
          ...
          <p className="mt-5 text-gray-600 sm:text-lg">
            Whether you&apos;re just trying out our service or you need more,
            we&apos;ve got you covered.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-10 p-12 lg:grid-cols-2">
          <TooltipProvider>
            { pricingItems.map(({ plan, features, quota, tagline }) => {
              ...
              return (
                <div
                  ...
                  <div className="flex h-20 justify-center border-b border-t border-gray-200 bg-gray-50">
